...
const AddStaffModal = ({ open, onClose, editData, refetch }) => {
    ...
    const validationSchema = Yup.object({
        ...
        password: !editData._id && Yup.string().min(8, 'Password must be at least 8 characters').required('Password is required'),
                                                ...
                                                <Table>
                                                    <TableHead>
                                                        <TableRow sx={{ backgroundColor: '#eaf3fa' }}>
                                                            ...
                                                            <TableCell sx={{ fontWeight: 'bold' }}>Company Type Group</TableCell>
