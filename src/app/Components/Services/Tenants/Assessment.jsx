...
const Assessment = ({ setValues, values, handleChange, handleSubmit, setFieldValue, Field }) => {
    // console.log(values)
    return (
        <>
        ...
        <Grid flexDirection='column' marginTop={4} spacing={2} container>
            <Grid item xs={12} sm={6}>
                <FlotingLableInput
                    ...
                    type="date"
                    fullWidth
                    value={values.dateOfBirth} // New field
                    onChange={(e) => { handleChange(e) }}
                    InputLabelProps={{
                        shrink: true,
                    }}
            ...
            <Grid item xs={12} sm={6}>
                <FlotingLableInput
                    // as={TextField}
                    name="firstName" // New field
                    label="First Name"
                    type="text"
                    required
                    fullWidth
                    value={values.firstName} // New field
                    onChange={(e) => { handleChange(e) }}
                />
            </Grid>
            <Grid item xs={12} sm={6}>
                <FlotingLableInput
                    ...
                    type="text"
                    fullWidth
                    value={values.middleName} // New field
                    onChange={(e) => { handleChange(e) }}
                />
            </Grid>
            <Grid item xs={12} sm={6}>
                <FlotingLableInput
                    ...
                    required
                    fullWidth
                    value={values.lastName} // New field
                    onChange={(e) => { handleChange(e) }}
                />
            </Grid>
