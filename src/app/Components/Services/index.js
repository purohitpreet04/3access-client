...
export const PendingTenants = Loadable(lazy(() => import("./Tenants/PendingTenants.jsx")))
export const ExistingTenants = Loadable(lazy(() => import("./Tenants/ExistingTenant.jsx")))
