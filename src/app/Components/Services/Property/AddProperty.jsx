...
function AddProperty({ open, onClose, editData }) {
    ...
    const { selectedValues, comData, propertydata } = useSelector(state => state.sideselect)
                        ...
                        <Form>
                            ...
                            <Grid p={4} container spacing={2} >
                                ...
                                <Grid item xs={12} sm={9}>
                                    ...
                                    {/* {(['company-agent'].includes(user?.role)) && <Field
                                        as={TextField}
                                        select
                                        fullWidth
                                    ...
                                    {((['staff'].includes(user?.role) && ['company'].includes(user?.addedBy?.role) || ['company', 'company-agent'].includes(user?.role))) && <Field
                                        as={TextField}
                                        select
                                        fullWidth
                                        label="RSL (Type/Group)"
                                    ...
                                    {((['staff'].includes(user?.role) && ['agent'].includes(user?.addedBy?.role) || ['agent'].includes(user?.role))) && <Field
                                        as={TextField}
                                        select
                                        fullWidth
                                        label="RSL (Type/Group)"
